...
const cubicBezier = require('./cubic-bezier-16d7da31.js');
const index$1 = require('./index-358b0adf.js');
...
const index$3 = require('./index-ece6a179.js');
const index$2 = require('./index-94145b59.js');
const spinnerConfigs = require('./spinner-configs-7360a407.js');
require('./index-039e2aea.js');
...
const Refresher = class {
  ...
  async connectedCallback() {
    ...
    this.backgroundContentEl = helpers.getElementRoot(backgroundContentHost).querySelector('#background-content');
...
const RefresherContent = class {
  ...
  componentWillLoad() {
    if (this.pullingIcon === undefined) {
      const mode = ionicGlobal.getIonMode(this);
      const overflowRefresher = this.el.style.webkitOverflowScrolling !== undefined ? 'lines' : index$3.arrowDown;
  ...
  render() {
    ...
    const mode = ionicGlobal.getIonMode(this);
    return (index.h(index.Host, { class: mode }, index.h("div", { class: "refresher-pulling" }, this.pullingIcon && hasSpinner && (index.h("div", { class: "refresher-pulling-icon" }, index.h("div", { class: "spinner-arrow-container" }, index.h("ion-spinner", { name: this.pullingIcon, paused: true }), mode === 'md' && this.pullingIcon === 'circular' && (index.h("div", { class: "arrow-container" }, index.h("ion-icon", { icon: index$3.caretBackSharp })))))), this.pullingIcon && !hasSpinner && (index.h("div", { class: "refresher-pulling-icon" }, index.h("ion-icon", { icon: this.pullingIcon, lazy: false }))), this.pullingText && (index.h("div", { class: "refresher-pulling-text", innerHTML: index$2.sanitizeDOMString(this.pullingText) }))), index.h("div", { class: "refresher-refreshing" }, this.refreshingSpinner && (index.h("div", { class: "refresher-refreshing-icon" }, index.h("ion-spinner", { name: this.refreshingSpinner }))), this.refreshingText && (index.h("div", { class: "refresher-refreshing-text", innerHTML: index$2.sanitizeDOMString(this.refreshingText) })))));
  }
  get el() { return index.getElement(this); }
};
