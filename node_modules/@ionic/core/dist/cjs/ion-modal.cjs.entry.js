...
const Modal = class {
  constructor(hostRef) {
    ...
    this.ionBreakpointDidChange = index$1.createEvent(this, "ionBreakpointDidChange", 7);
  ...
  async setCurrentBreakpoint(breakpoint) {
    if (!this.isSheetModal) {
      index$2.printIonWarning('setCurrentBreakpoint is only supported on sheet modals.');
      return;
    }
    if (!this.breakpoints.includes(breakpoint)) {
      index$2.printIonWarning(`Attempted to set invalid breakpoint value ${breakpoint}. Please double check that the breakpoint value is part of your defined breakpoints.`);
      return;
    }
