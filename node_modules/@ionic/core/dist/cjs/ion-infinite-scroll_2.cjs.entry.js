...
const InfiniteScrollContent = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { class: "infinite-loading" }, this.loadingSpinner && (index.h("div", { class: "infinite-loading-spinner" }, index.h("ion-spinner", { name: this.loadingSpinner }))), this.loadingText && index.h("div", { class: "infinite-loading-text", innerHTML: index$2.sanitizeDOMString(this.loadingText) }))));
  }
};
