...
const index$2 = require('./index-ece6a179.js');
const ionicGlobal = require('./ionic-global-3477fef9.js');
const focusVisible = require('./focus-visible-13f6b222.js');
const helpers = require('./helpers-f20dea36.js');
const index$1 = require('./index-039e2aea.js');
const dir = require('./dir-186d3a4d.js');
const theme = require('./theme-e6fec71e.js');
const overlays = require('./overlays-0aef7441.js');
const animation = require('./animation-519a3f58.js');
...
const Datetime = class {
  ...
  valueChanged() {
    if (this.hasValue()) {
      ...
      if (valueDateParts) {
        ...
        index$1.printIonWarning(`Unable to parse date string: ${this.value}. Please provide a valid ISO 8601 datetime string.`);
      }
    }
    this.emitStyle();
    this.ionChange.emit({
  ...
  renderYearView() {
    ...
    return (index.h("div", { class: "datetime-year" }, index.h("div", { class: {
      ...
      } }, index.h("ion-picker-internal", null, showMonth && (index.h("ion-picker-column-internal", { class: "month-column", color: this.color, items: months, value: workingParts.month, onIonChange: (ev) => {
        ...
        this.initializeCalendarIOListeners();
        ev.stopPropagation();
      } })), showYear && (index.h("ion-picker-column-internal", { class: "year-column", color: this.color, items: years, value: workingParts.year, onIonChange: (ev) => {
        // Due to a Safari 14 issue we need to destroy
        // the intersection observer before we update state
        // and trigger a re-render.
        if (this.destroyCalendarIO) {
  ...
  renderMonth(month, year) {
    ...
    return (index.h("div", { class: {
      ...
      } }, index.h("div", { class: "calendar-month-grid" }, getDaysOfMonth(month, year, this.firstDayOfWeek % 7).map((dateObject, index$2) => {
  ...
  renderTime() {
    ...
    return (index.h("div", { class: "datetime-time" }, timeOnlyPresentation
...
const PickerColumnCmp = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await Promise.resolve().then(function () { return require('./index-93e6ac74.js'); })).createGesture({
      el: this.el,
