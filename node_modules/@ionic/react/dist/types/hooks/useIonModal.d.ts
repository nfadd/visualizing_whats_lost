import { ModalOptions } from '@ionic/core/components';
...
export declare type UseIonModalResult = [(options?: Omit<ModalOptions, 'component' | 'componentProps'> & HookOverlayOptions) => void, 
/**
 * Dismisses the modal
 */
() => void];
